...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("t3azwrbl")

  // remove
  collection.schema.removeField("cuc55h0x")

  // remove
  collection.schema.removeField("xyxkye5w")

  // remove
  collection.schema.removeField("dpy6jgnh")

  // remove
  collection.schema.removeField("b8jksboj")
